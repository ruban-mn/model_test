...
st.markdown("<h2 style='text-align: center;'>мастер отчетов</h2>", unsafe_allow_html=True)
st.markdown("<h2 style='text-align: center;'>независимой оценки качества услуг</h2>", unsafe_allow_html=True)

st.subheader(':blue[перейдите на страницу с требуемым расчетом]:', divider='red')

st.subheader(':red[перед загрузкой файлов удетитесь что они соответствуют образцу]:', divider='red')
