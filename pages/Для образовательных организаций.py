...
for index, row in output_df.iterrows():
    ...
    # Добавляем результат проверки условия в столбец "Недостатки"
    if sorted_table.loc[(sorted_table['Наименование организации или П/Н по списку'] == row['Name_org']) & (sorted_table['К4'] < 90)].values[0]:
    ...
    # Добавляем результат проверки условия в столбец "Недостатки"
    if sorted_table.loc[(sorted_table['Наименование организации или П/Н по списку'] == row['Name_org']) & (sorted_table['К5'] < 90)].values[0]:
