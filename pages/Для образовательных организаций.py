...
for index, row in output_df.iterrows():
    ...
    if Raschet_ballov.loc[(Raschet_ballov['Наименование организации или П/Н по списку'] == row['Name_org']) & (Raschet_ballov['Пдостуд'] < 90)].values[0]:
        result_k3 = "Провести инструктаж и обучение сотрудников по вопросам обеспечения доступности организации для инвалидов, в т.ч. по сопровождению маломобильных граждан в помещениях организации и на прилегающей территории с учетом имеющихся у них ограничений и расстройств, по оказанию содействия инвалиду в беспрепятственном получении услуги.
