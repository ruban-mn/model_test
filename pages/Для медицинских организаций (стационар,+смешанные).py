...
Answers_respond['v30'] = Answers_respond['v8'].map({'24 часа и более': 24})
Answers_respond['v31'] = Answers_respond['v22'].map({'14 календарных дней и более': 14})
...
Answers_respond1['v36'] = Answers_respond1['v8'].map({'15 календарных дней': 15})
Answers_respond1['v37'] = Answers_respond1['v15'].map({'24 часа и более': 24})
Answers_respond1['v38'] = Answers_respond1['v29'].map({'14 календарных дней и более': 14})
...
Raschet_ballov['Пинф'] = round(0.5*((Raschet_ballov['Истенд']/Raschet_ballov['Инорм-стенд'])+(Raschet_ballov['Исайт']/Raschet_ballov['Инорм-сайт']))*60, 2)
...
Raschet_ballov['ожид'] = ans_all['_v44_']
Raschet_ballov['Усвоевр'] = ans_all['_v45_']
Raschet_ballov['Чобщ'] = ans_all['_v56_']
Raschet_ballov['Пожид'] = (round(Raschet_ballov['Усвоевр']/Raschet_ballov['Чобщ']*100, 2) + Raschet_ballov['ожид'])/2
Raschet_ballov['Укомф'] = ans_all['_v46_']
Raschet_ballov['Чобщ'] = ans_all['_v57_']
...
Raschet_ballov['Удост'] = ans_all['_v48_']
Raschet_ballov['Чинв'] = ans_all['_v47_']
...
Raschet_ballov['Уперв.конт'] = ans_all['_v49_']
Raschet_ballov['Чобщ1'] = ans_all['_v58_']
Raschet_ballov['Пперв.контуд'] = round(Raschet_ballov['Уперв.конт']/Raschet_ballov['Чобщ1']*100, 2)
Raschet_ballov['Уоказ.услуг'] = ans_all['_v50_']
Raschet_ballov['Чобщ2'] = ans_all['_v59_']
Raschet_ballov['Показ.услугуд'] = round(Raschet_ballov['Уоказ.услуг']/Raschet_ballov['Чобщ2']*100, 2)
Raschet_ballov['Увежл.дист'] = ans_all['_v52_']
Raschet_ballov['Чобщ_ус'] = ans_all['_v51_']
...
Raschet_ballov['Уреком'] = ans_all['_v53_']
Raschet_ballov['Чобщ3'] = ans_all['_v60_']
Raschet_ballov['Преком'] = round(Raschet_ballov['Уреком']/Raschet_ballov['Чобщ3']*100, 2)
Raschet_ballov['Уорг.усл'] = ans_all['_v54_']
Raschet_ballov['Чобщ4'] = ans_all['_v60_']
Raschet_ballov['Порг.услуд'] = round(Raschet_ballov['Уорг.усл']/Raschet_ballov['Чобщ4']*100, 2)
Raschet_ballov['Ууд'] = ans_all['_v55_']
Raschet_ballov['Чобщ5'] = ans_all['_v60_']
