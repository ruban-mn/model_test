...
for index, row in output_df.iterrows():
    ...
    K3_list = int(table15.loc[table15['Наименование организации или П/Н по списку'] == row['Наименование организации или П/Н по списку'], 'К3'].values[0])
    ...
    K4_list = int(table15.loc[table15['Наименование организации или П/Н по списку'] == row['Наименование организации или П/Н по списку'], 'К4'].values[0])
    ...
    # Добавляем результат проверки условия в столбец "Недостатки"
    K5_list = int(table15.loc[table15['Наименование организации или П/Н по списку'] == row['Наименование организации или П/Н по списку'], 'К5'].values[0])
