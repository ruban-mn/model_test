...
sum_Raschet_ballov_transposed['1 БУК ВО «Вологодская областная универсальная научная библиотека им. И.В. Бабушкина»'] = 
round(
...
sum_Raschet_ballov_transposed['10 БУК ВО «Вологодский областной театр кукол «Теремок»'] = 
round(
    Raschet_ballov_transposed['10 БУК ВО «Вологодский областной театр кукол «Теремок»'], 
    0
)
sum_Raschet_ballov_transposed['11 АУК ВО «Вологодская областная государственная филармония им. В.А.Гаврилина»'] = 
round(
    Raschet_ballov_transposed['11 АУК ВО «Вологодская областная государственная филармония им. В.А.Гаврилина»'], 
    0
)
sum_Raschet_ballov_transposed['12 Автономное учреждение культуры Вологодской области «Вологдареставрация»'] = 
round(Raschet_ballov_transposed['12 Автономное учреждение культуры Вологодской области «Вологдареставрация» (в отношении Культурно-просветительского и духовного центра «Усадьбы Вологодчины»)'], 
      0
     )
sum_Raschet_ballov_transposed['13 БУК ВО «Центр народной культуры»'] = 
round(
    Raschet_ballov_transposed['13 БУК ВО «Центр народной культуры»'], 
    0
)
sum_Raschet_ballov_transposed['2 БУК ВО «Вологодская областная детская библиотека»'] = 
round(
    Raschet_ballov_transposed['2 БУК ВО «Вологодская областная детская библиотека»'], 
    0
)
sum_Raschet_ballov_transposed['3 БУК ВО «Вологодская областная специальная библиотека для слепых»'] = 
round(
    Raschet_ballov_transposed['3 БУК ВО «Вологодская областная специальная библиотека для слепых»'], 
    0
)
sum_Raschet_ballov_transposed['4 БУК ВО «Вологодский государственный историко-архитектурный и художественный музей-заповедник»'] = 
round(
...
sum_Raschet_ballov_transposed['5 БУК ВО «Вологодская областная картинная галерея»'] = 
round(
...
sum_Raschet_ballov_transposed['6 БУК ВО «Великоустюгский государственный историко-архитектурный и художественный музей-заповедник»'] = 
round(
...
sum_Raschet_ballov_transposed['7 БУК ВО «Белозерский областной краеведческий музей»'] = 
round(
...
sum_Raschet_ballov_transposed['8 АУК ВО «Вологодский ордена «Знак Почета» государственный драматический театр»'] = 
round(
    Raschet_ballov_transposed['8 АУК ВО «Вологодский ордена «Знак Почета» государственный драматический театр»'], 
    0
)
sum_Raschet_ballov_transposed['9 БУК ВО «Вологодский областной театр юного зрителя»'] = 
round(
