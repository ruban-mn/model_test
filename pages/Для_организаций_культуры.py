...
sum_Raschet_ballov_transposed['1 БУК ВО «Вологодская областная универсальная научная библиотека им. И.В. Бабушкина»'] = round((Raschet_ballov_transposed['1 БУК ВО «Вологодская областная универсальная научная библиотека им. И.В. Бабушкина»'] + Raschet_ballov_transposed['1ф Филиал БУК ВО «Вологодская областная универсальная научная библиотека им. И.В. Бабушкина»'])/2, 0)
sum_Raschet_ballov_transposed['10 БУК ВО «Вологодский областной театр кукол «Теремок»'] = round(Raschet_ballov_transposed['10 БУК ВО «Вологодский областной театр кукол «Теремок»'], 0)
sum_Raschet_ballov_transposed['11 АУК ВО «Вологодская областная государственная филармония им. В.А.Гаврилина»'] = round(Raschet_ballov_transposed['11 АУК ВО «Вологодская областная государственная филармония им. В.А.Гаврилина»'], 0)
sum_Raschet_ballov_transposed['12 Автономное учреждение культуры Вологодской области «Вологдареставрация»'] = round(Raschet_ballov_transposed['12 Автономное учреждение культуры Вологодской области «Вологдареставрация» (в отношении Культурно-просветительского и духовного центра «Усадьбы Вологодчины»)'], 0)
sum_Raschet_ballov_transposed['13 БУК ВО «Центр народной культуры»'] = round(Raschet_ballov_transposed['13 БУК ВО «Центр народной культуры»'], 0)
sum_Raschet_ballov_transposed['2 БУК ВО «Вологодская областная детская библиотека»'] = round(Raschet_ballov_transposed['2 БУК ВО «Вологодская областная детская библиотека»'], 0)
sum_Raschet_ballov_transposed['3 БУК ВО «Вологодская областная специальная библиотека для слепых»'] = round(Raschet_ballov_transposed['3 БУК ВО «Вологодская областная специальная библиотека для слепых»'], 0)
sum_Raschet_ballov_transposed['4 БУК ВО «Вологодский государственный историко-архитектурный и художественный музей-заповедник»'] = round((Raschet_ballov_transposed['4 БУК ВО «Вологодский государственный историко-архитектурный и художественный музей-заповедник»'] + Raschet_ballov_transposed['4ф Архитектурно–этнографический музей Вологодской области («Семёнково»)'] + Raschet_ballov_transposed['4ф Выставочный комплекс "Вологда на рубеже XIX - XX веков"'] + Raschet_ballov_transposed['4ф Дом-музей А. Ф. Можайского'] + Raschet_ballov_transposed['4ф Дом-музей Петра I'] + Raschet_ballov_transposed['4ф Музей «Вологодская ссылка»'] + Raschet_ballov_transposed['4ф Музей «Литература. Искусство. Век ХХ»'] + Raschet_ballov_transposed['4ф Музей кружева'] + Raschet_ballov_transposed['4ф ОП Мухей "мир забытых вещей'])/9, 0)
sum_Raschet_ballov_transposed['5 БУК ВО «Вологодская областная картинная галерея»'] = round((Raschet_ballov_transposed['5 БУК ВО «Вологодская областная картинная галерея»'] + Raschet_ballov_transposed['5ф Дом Корбаковам'] + Raschet_ballov_transposed['5ф Мастерская А.В. Пантелеева'] + Raschet_ballov_transposed['5ф Шаламовский дом'])/4, 0)
sum_Raschet_ballov_transposed['6 БУК ВО «Великоустюгский государственный историко-архитектурный и художественный музей-заповедник»'] = round((Raschet_ballov_transposed['6 БУК ВО «Великоустюгский государственный историко-архитектурный и художественный музей-заповедник»'] + Raschet_ballov_transposed['6ф Ансамбль Троице-Гледенского монастыря'] + Raschet_ballov_transposed['6ф Выставочный зал'] + Raschet_ballov_transposed['6ф Депозитарий'] + Raschet_ballov_transposed['6ф Детский музейный центр'] + Raschet_ballov_transposed['6ф Музей древнерусского искусства'] + Raschet_ballov_transposed['6ф Музей истории и культуры'] + Raschet_ballov_transposed['6ф Музей новогодней и рождественской игрушки'] + Raschet_ballov_transposed['6ф Музей природы края'] + Raschet_ballov_transposed['6ф Собор Архангела Михаила'])/10, 0)
sum_Raschet_ballov_transposed['7 БУК ВО «Белозерский областной краеведческий музей»'] = round((Raschet_ballov_transposed['7 БУК ВО «Белозерский областной краеведческий музей»'] + Raschet_ballov_transposed['7ф Мемориальный дом музей поэта С.С. Орлова'] + Raschet_ballov_transposed['7ф Музей белого озера'] + Raschet_ballov_transposed['7ф Музей этнографии'] + Raschet_ballov_transposed['7ф Спасо-Преображенский собор'])/5, 0)
sum_Raschet_ballov_transposed['8 АУК ВО «Вологодский ордена «Знак Почета» государственный драматический театр»'] = round(Raschet_ballov_transposed['8 АУК ВО «Вологодский ордена «Знак Почета» государственный драматический театр»'], 0)
sum_Raschet_ballov_transposed['9 БУК ВО «Вологодский областной театр юного зрителя»'] = round(Raschet_ballov_transposed['9 БУК ВО «Вологодский областной театр юного зрителя»'], 0)
