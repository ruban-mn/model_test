...
st.subheader('Независимая оценка качества услуг социальных организаций')
...
for i in range(16):  # Цикл от 0 до 18
...
Raschet_ballov['Истенд'] = chek_list.filter(like='Основные сведения на СТЕНДЕ').sum(axis=1)
Raschet_ballov['Исайт'] = chek_list.filter(like='Основные сведения на САЙТЕ').sum(axis=1)
Raschet_ballov['Инорм-стенд'] = chek_list.filter(like='Основные сведения на СТЕНДЕ').count(axis=1)
Raschet_ballov['Инорм-сайт'] = chek_list.filter(like='Основные сведения на САЙТЕ').count(axis=1)
...
Raschet_ballov['К5'] = Raschet_ballov['К5'].fillna(0)
...
chek_list_dist = chek_list.iloc[:, 37:41]  # Датафрейм с 6-10 столбцами
chek_list_komf = chek_list.iloc[:, 42:47]
chek_list_obor_inv = chek_list.iloc[:, 48:52]
chek_list_sreda_inv = chek_list.iloc[:, 53:59]
...
run = under_zag.add_run("Результаты независимой оценки качества условий оказания услуг социальными учреждениями")
font = run.font
run.bold = True
font.size = Pt(16) 
under_zag.alignment = WD_PARAGRAPH_ALIGNMENT.CENTER
name_otchet = otchet.add_paragraph()
run = name_otchet.add_run("Критерий 1. Открытость и доступность информации об социальном учреждении")
run.bold = True
font = run.font
font.size = Pt(16) 
...
abz1 = otchet.add_paragraph("Показатель 1.1.	 Соответствие информации о деятельности социального учреждения, размещенной на общедоступных информационных ресурсах, ее содержанию и порядку (форме), установленным нормативными правовыми актами (на информационных стендах в помещении социального учреждения; на официальном сайте социального учреждения в сети «Интернет»).")
abz2 = otchet.add_paragraph("Показатель 1.2. 	Наличие на официальном сайте социального учреждения информации о дистанционных способах обратной связи и взаимодействия с получателями услуг и их функционирование (абонентского номера телефона; адреса электронной почты; электронных сервисов (для подачи электронного обращения (жалобы, предложения), получения консультации по оказываемым услугам и иных.); раздела официального сайта «Часто задаваемые вопросы»; технической возможности выражения получателем услуг мнения о качестве условий оказания услуг социальным учреждением (наличие анкеты для опроса граждан или гиперссылки на нее)).")
abz3 = otchet.add_paragraph("Показатель 1.3.	 Доля получателей услуг, удовлетворенных открытостью, полнотой и доступностью информации о деятельности социального учреждения, размещенной на информационных стендах в помещении социального учреждения, на официальном сайте социального учреждения в сети «Интернет» (в % от общего числа опрошенных получателей услуг).")
...
abz6 = otchet.add_paragraph(f"Итоговые баллы по критерию «Открытость и доступность информации о социальном учреждении» варьируются от {min_value} до {max_value} баллов. Средний итоговый балл по критерию {mean_value}.")
...
abz11 = otchet.add_paragraph("Показатель 2.1. Обеспечение в социальном учреждении комфортных условий пребывания (транспортная/ пешая доступность социального учреждения, санитарное состояние помещений и территории учреждения, наличие и доступность питьевой воды, санитарно-гигиенических помещений, достаточность гардеробов)")
abz12 = otchet.add_paragraph("Показатель 2.3. Доля получателей услуг, удовлетворенных комфортностью предоставления услуг социальным учреждением (в % от общего числа опрошенных получателей услуг).")
...
abz31 = otchet.add_paragraph("Показатель 4.1. Доля получателей услуг, удовлетворенных доброжелательностью, вежливостью работников социального учреждения, обеспечивающих первичный контакт и информирование получателя услуги при непосредственном обращении в организацию образования (в % от общего числа опрошенных получателей услуг)")
abz32 = otchet.add_paragraph("Показатель 4.2. Доля получателей услуг, удовлетворенных доброжелательностью, вежливостью работников социального учреждения, обеспечивающих непосредственное оказание услуги при обращении в организацию образования (в % от общего числа опрошенных получателей услуг)")
abz33 = otchet.add_paragraph("Показатель 4.3. Доля получателей услуг, удовлетворенных доброжелательностью, вежливостью работников социального учреждения при использовании дистанционных форм взаимодействия (в % от общего числа опрошенных получателей услуг).")
...
abz43 = otchet.add_paragraph("Показатель 5.3. Доля получателей услуг, удовлетворенных в целом условиями оказания услуг в социальном учреждении (в % от общего числа опрошенных получателей услуг).")
...
under_zag = otchet.add_paragraph()
run = under_zag.add_run("Итоговая оценка качества условий оказания услуг социальными учреждениями. Рейтинг учреждений")
font = run.font
run.bold = True
font.size = Pt(16) 
under_zag.alignment = WD_PARAGRAPH_ALIGNMENT.CENTER
name_otchet = otchet.add_paragraph()
run = name_otchet.add_run("Общий рейтинг социальных учреждений.")
run.bold = True
font = run.font
font.size = Pt(16) 
name_otchet.alignment = WD_PARAGRAPH_ALIGNMENT.CENTER
...
under_zag = otchet.add_paragraph()
run = under_zag.add_run(f"Основные выводы и рекомендации по результатам независимой оценки качества условий оказания услуг социальных учреждений {plase}.")
font = run.font
run.bold = True
font.size = Pt(16) 
under_zag.alignment = WD_PARAGRAPH_ALIGNMENT.CENTER
