...
for index, row in output_df.iterrows():
    ...
    if K4_list < 90:
        ...
        result_k4 = 'Получатели услуг удовлетворены веждивостью и доброжелательностью работников учреждения.'
    ...
    if K5_list < 90:
        ...
        result_k5 = 'Получатели услуг удовлетворены оказанием услуг организацией в целом.'
